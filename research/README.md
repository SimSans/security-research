...
|---|---|---|---|
| [**The Mirage**](the-mirage.md) | Transient-storage (EIP-1153) simulation divergence — defeats wallet previews, "is-this-safe" scanners, DEX-aggregator quotes, and ERC-4337 per-userOp validation | Responsible-disclosure draft; targets = simulation vendors + 4337 infra | [6 passing Foundry tests](mirage-poc/) |
