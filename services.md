...
- **Range:** [50+ protocols reviewed](coverage/protocols-reviewed.md) across Solidity, Move, Rust, Go, Clarity, and Vyper, covering lending, perps, CDP stablecoins, vaults, AMMs, bridges, restaking, and account abstraction.
